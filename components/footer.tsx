      ...
      <div className="container mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">Track-kar</h3>
            <p className="text-sm text-muted-foreground">
              Advanced GPS tracking solutions for your fleet management needs.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-sm text-muted-foreground hover:text-primary">GPS Devices</a></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Track-kar. All rights reserved.
          </p>
